...
sealed class Screen(val route: String) {
    ...
    object NoteDetailsScreen : Screen("note_detail_screen/{${Constants.NOTE_ID_ARG}}?${Constants.FOLDER_NAME}={${Constants.FOLDER_NAME}}")
    ...
    object NoteFolderDetailsScreen : Screen("note_folder_details_screen/{${Constants.FOLDER_NAME}}")
}